...
@testset "remez_20_hilbert" begin
    h = remez_wrap(20, [0.1, 0.95],[1.0]; filter_type="hilbert", Hz=2.0);
...
@testset "remez_21_hilbert" begin
    h = remez_wrap(21, [0.1, 0.95],[1.0]; filter_type="hilbert", Hz=2.0);
...
@testset "remez_200_differentiator" begin
    h = remez_wrap(200, [0.01, 0.99],[1.0]; filter_type="differentiator", Hz=2.0);
...
@testset "remez_201_differentiator" begin
    h = remez_wrap(201, [0.05, 0.95],[1.0]; filter_type="differentiator", Hz=2.0);
